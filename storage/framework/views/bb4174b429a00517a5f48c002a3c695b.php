                            ...
                            <div class="panel">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input
                                            type="text"
                                            value="<?php echo e($row->related_ids); ?>"
                                            placeholder="<?php echo e(__("Eg: 100,200")); ?>"
                                            name="related_ids"
                                            class="form-control"
                                        >
                                        <p>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Gotrip.1.6.1\modules/Hotel/Views/admin/detail.blade.php ENDPATH**/ ?>